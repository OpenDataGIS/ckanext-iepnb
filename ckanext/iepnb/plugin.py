import ckanext.iepnb.cli as cli
...
class IepnbPlugin(plugins.SingletonPlugin, DefaultTranslation):
    ...
    def update_config(self, config_):
        ...
        iepnb_config.server_i18n = config.get('iepnb.server_i18n', iepnb_config.server_i18n)
        ...
        iepnb_config.featured_datasets = toolkit.asint(config.get('iepnb.featured_datasets', 4))
    ...
    def read_template(self):
        return "iepnb/package/read.html"
